                    ...
                    <div class="navegador_escritorio justify-content-center align-items-center">
                            ...
                            <div class="col-9 h-100">
                                <div class="d-flex justify-content-end align-items-center h-100">
                                    <a class="btn_menu_nav h-100 alineado_centro activado" href="index.php">
                ...
                <div class="col-12">
                    ...
                    <div class="ancho_800 m-t-30">
                        <div class="row no-gutters justify-content-center align-items-center">
                            <div class="cool-11 col-sm-7">
                                <img class="w-100" src="img/coycoce_quienes_somos.jpg" alt="quienes somos coycoce">
                            </div>
                            <div class="cool-11 col-sm-5 align-self-center">
                                <p class="texto_book texto_index">
