                    ...
                    <div class="navegador_escritorio justify-content-center align-items-center">
                            ...
                            <div class="col-9 h-100">
                                <div class="d-flex justify-content-end align-items-center h-100">
                                    ...
                                    <a class="btn_menu_nav h-100 alineado_centro activado" href="proyectos.php">
                    ...
                    <div class="ancho_800">
                        <div class="row justify-content-center" id=''>
                            <div class="col-12 m-t-10 m-b-10">
                                <img class="w-100" src="img/nuestro_expertice.svg" alt="nuestros valores COYCOCE">
                            </div>
                            <div class="col-12">
                                <img class="w-100" src="img/expertice_imagen.jpg" alt="expertice COYCOCE">
                            </div>
                            <div class="col-12">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-11 proyectos_coyco">
                                        <h2 class='m-t-20'>Experiencia De La Empresa</h2>
                                        <h2 class='m-t-20'>2017 - 2018</h2>
                                        <p>
                                            Construcción De Parque Espacio Familiar En La Localidad Cardenas
                                        </p>
                                        <p>
                                            Remodelación De La Calle Diego Hernandez En La Colonia Humanista 2
                                        </p>
                                        <p>
                                            Remodelación De Los Baños De La Academia De Policias En El Minucipio De Salamanca Guanajuato.
                                        </p>
                                        <p>
                                            Construcción De La Primer Etapa Del Asilo Canino En La Comunidad De Valtierrilla Guanajuato
                                        </p>
                                        <p>
                                            Trabajos De Infraestructura Para Adecuaciones, Mantenimientos Mayores Y Rehabilitaciones En El Cecyte Plantel Salamanca
                                        </p>
                                        <p>
                                            Trabajo De Mantenimiento Preventivo De Las Redes De Alcantarillado En El Municipio De Salamanca
                                        </p>
                                    </div>
                                </div>
                            </div>
